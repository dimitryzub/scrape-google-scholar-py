...
def parse(parser: Callable, top_mandates_data: Callable):
    ...
    for table in parser.css('tr'):
        ...
        top_mandates_data.append({
            ...
            '2020': twenty_twenty,
            '2021': twenty_one,
            # 'overall': overall # fix selsector
        })


def google_scholar_top_mandates_metrics(operating_system: str = 'Windows' or 'Linux',
    ...
    Usage:
    data = google_scholar_top_mandates_metrics(operating_system='win', lang='sv', operating_system='windows') # sv = swedish
    ...
    parse(parser=parser, top_mandates_data=top_mandates_data)
