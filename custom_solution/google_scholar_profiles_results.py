...
def parse(parser: Callable, profile_results_data: Callable):
    '''
    Arugments:
...
def scrape_google_scholar_profiles(query: str, pagination: bool = False, operating_system: str = 'Windows' or 'Linux') -> List[Dict[str, str]]:
    '''
    ...
    if pagination:
        while True:
            ...
            if params.get('after_author') is None:
                ...
                parse(parser=parser, profile_results_data=profile_results_data)
